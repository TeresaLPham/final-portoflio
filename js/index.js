...
const buttonLetsPlay = document.querySelector('.letsPlayButton')
  ...
  function letsPlay(){ 
  var numberPlay = prompt("How many times do you want to play?", "1");
  ...
  buttonLetsPlay.style.backgroundColor = 'black';
  document.getElementById("timesPlay").style.border = "thin solid #A020F0";
